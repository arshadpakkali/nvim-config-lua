...
_G.packer_plugins = {
  ...
  ["cmp-vsnip"] = {
    loaded = true,
    path = "/home/arshad/.local/share/nvim/site/pack/packer/start/cmp-vsnip",
  ...
  ["nvim-dap"] = {
    ...
    loaded = true,
    path = "/home/arshad/.local/share/nvim/site/pack/packer/start/nvim-dap",
  ...
  ["vim-vsnip"] = {
    loaded = true,
    path = "/home/arshad/.local/share/nvim/site/pack/packer/start/vim-vsnip",
